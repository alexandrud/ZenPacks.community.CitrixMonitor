...
NAME = "ZenPacks.community.CitrixMonitor"
VERSION = "1.0.0"
AUTHOR = "Ioan Damian"
LICENSE = "LGPL"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.community']
PACKAGES = ['ZenPacks', 'ZenPacks.community', 'ZenPacks.community.CitrixMonitor']
INSTALL_REQUIRES = ['ZenPacks.zenoss.ZenossVirtualHostMonitor>=2.4.0']
